...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . MaterialDidactico::label(2), 'icon' => 'list', 'itemOptions'=>array('class'=>'active')),
...
<fieldset>
    <legend>
        <?php echo Yii::t('AweCrud.app', 'List') ?> <?php echo MaterialDidactico::label(2) ?>    </legend>
