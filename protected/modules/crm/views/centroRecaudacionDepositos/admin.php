...
<div class="widget blue">
    <div class="widget-title">
        <h4> <i class="icon-fire-extinguisher"></i> <?php echo Yii::t('AweCrud.app', 'Manage') ?> <?php echo CentroRecaudacionDepositos::label(2) ?> </h4>
        <span class="tools">
    ...
    <div class="widget-body">
        ...
        'id' => 'centro-recaudacion-depositos-grid',
