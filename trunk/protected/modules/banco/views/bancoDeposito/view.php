...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . BancoDeposito::label(2), 'icon' => 'list', 'url' => array('index')),
...
<?php $this->widget('bootstrap.widgets.TbDetailView',array(
	...
	'attributes' => array(
             ...
             array(
			'name' => 'BANCO_ID',
			'value'=>($model->bANCO !== null) ? CHtml::link($model->bANCO, array('/banco/view', 'ID' => $model->bANCO->ID)).' ' : null,
			'type' => 'html',
		),
             array(
